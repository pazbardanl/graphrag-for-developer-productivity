...
class Processor:
    ...
    def process(self, json_string: str):
        ...
        if not author:
            ...
            return
        reviewer_scores = self.calculate_reviewer_scores(pr_weights, author)
        pr_reviewer_report = PRReviewerReport(pr_event_dto.pr_number, list(reviewer_scores.values()))
    ...
    def calculate_reviewer_scores(self, pr_weights: dict[int, float], original_pr_author) -> dict[str, float]:
