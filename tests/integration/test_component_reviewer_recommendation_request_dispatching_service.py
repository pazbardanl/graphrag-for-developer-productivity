...
EXPECTED_OUTPUT_FILE_PATH = "tests/test_data/expected_reviewer_recommendation_requests_4requests.json"
INPUT_TOPIC = "test_new_PR_events"
OUTPUT_TOPIC = "test_reviewer_recommendation_requests_heuristic"
