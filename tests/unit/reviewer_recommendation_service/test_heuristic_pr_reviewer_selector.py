...
@pytest.fixture
def pr1_pr_recommendation_request():
    return PrReviewerRecommendationRequest(
        pr_number=1,
        repo_name="repo1",
...
@pytest.fixture
def pr100_pr_recommendation_request_no_changed_files():
    return PrReviewerRecommendationRequest(
        pr_number=100,
        repo_name="repo1",
        selection_strategy=SelectionStrategy.HEURISTIC
...
@pytest.fixture
def pr100_pr_recommendation_request():
    return PrReviewerRecommendationRequest(
        pr_number=100,
        repo_name="repo1",
        selection_strategy=SelectionStrategy.HEURISTIC
...
@pytest.fixture
def pr4_pr_recommendation_request():
    return PrReviewerRecommendationRequest(
        pr_number=4,
        repo_name="repo1",
        selection_strategy=SelectionStrategy.HEURISTIC
...
@pytest.fixture
def pr8_pr_recommendation_request():
    return PrReviewerRecommendationRequest(
        pr_number=8,
        repo_name="repo1",
        selection_strategy=SelectionStrategy.HEURISTIC
...
def test_heuristic_pr_reviewer_selector_sanity(selector_with_mocks, pr1_pr_recommendation_request):
    ...
    actual_pr_reviewer_recommendation = selector_with_mocks.select(pr1_pr_recommendation_request)
...
def test_heuristic_pr_reviewer_selector_no_changed_files(selector_with_mocks, pr100_pr_recommendation_request_no_changed_files):
    expected_pr_reviewer_recommendation = PRReviewerRecommendation(
        pr_number=100,
    ...
    actual_pr_reviewer_recommendation = selector_with_mocks.select(pr100_pr_recommendation_request_no_changed_files)
    print(f"EXPECTED: {expected_pr_reviewer_recommendation}")
    print(f"ACTUAL: {actual_pr_reviewer_recommendation}")
    assert actual_pr_reviewer_recommendation == expected_pr_reviewer_recommendation

def test_heuristic_pr_reviewer_selector_exclude_author(selector_with_mocks, pr4_pr_recommendation_request):
    expected_pr_reviewer_recommendation = PRReviewerRecommendation(
        pr_number=4,
        recommended_reviewer="NO_RECOMMENDED_USER",
        selection_strategy=SelectionStrategy.HEURISTIC,
    ...
    actual_pr_reviewer_recommendation = selector_with_mocks.select(pr4_pr_recommendation_request)
    print(f"EXPECTED: {expected_pr_reviewer_recommendation}")
    print(f"ACTUAL: {actual_pr_reviewer_recommendation}")
    assert actual_pr_reviewer_recommendation == expected_pr_reviewer_recommendation

def test_heuristic_pr_reviewer_selector_no_relevant_prs(selector_with_mocks, pr100_pr_recommendation_request):
    expected_pr_reviewer_recommendation = PRReviewerRecommendation(
        pr_number=100,
        recommended_reviewer="NO_RECOMMENDED_USER",
        selection_strategy=SelectionStrategy.HEURISTIC,
    ...
    actual_pr_reviewer_recommendation = selector_with_mocks.select(pr100_pr_recommendation_request)
    print(f"EXPECTED: {expected_pr_reviewer_recommendation}")
    print(f"ACTUAL: {actual_pr_reviewer_recommendation}")
    assert actual_pr_reviewer_recommendation == expected_pr_reviewer_recommendation

def test_heuristic_pr_reviewer_selector_tie(selector_with_mocks, pr8_pr_recommendation_request):
    expected_pr_reviewer_recommendation = PRReviewerRecommendation(
        pr_number=8,
    ...
    actual_pr_reviewer_recommendation = selector_with_mocks.select(pr8_pr_recommendation_request)
    print(f"EXPECTED: {expected_pr_reviewer_recommendation}")
    print(f"ACTUAL: {actual_pr_reviewer_recommendation}")
    assert actual_pr_reviewer_recommendation == expected_pr_reviewer_recommendation
